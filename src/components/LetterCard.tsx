            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <div className="text-gray-700 leading-relaxed space-y-4">
                  <p className={`transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.4s', willChange: 'opacity' }}>
                    Kính gửi Quý Ông/Bà, Quý Gia đình và Quý Đối tác,
                  </p>
                  <p className={`transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.5s', willChange: 'opacity' }}>
                  ...
                  <p className={`transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.6s', willChange: 'opacity' }}>
                  ...
                  <p className={`transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.7s', willChange: 'opacity' }}>
                  ...
                  <ul className={`list-disc list-inside space-y-2 ml-4 transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.8s', willChange: 'opacity' }}>
                  ...
                  <p className={`transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '0.9s', willChange: 'opacity' }}>
                  ...
                  <p className={`transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '1.0s', willChange: 'opacity' }}>
                  ...
                  <p className={`transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '1.1s', willChange: 'opacity' }}>
                    Trân trọng cảm ơn và kính chúc Quý vị luôn mạnh khỏe, hạnh phúc!
                  </p>
                  <div className={`text-center mt-8 transition-opacity duration-800 ease-out ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '1.2s', willChange: 'opacity' }}>
