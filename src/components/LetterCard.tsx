            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <div className="text-gray-700 leading-relaxed space-y-4">
                  <p className={`transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0.4s', willChange: 'transform, opacity' }}>
                    Kính gửi Quý Ông/Bà, Quý Gia đình và Quý Đối tác,
                  </p>
                  <p className={`transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0.5s', willChange: 'transform, opacity' }}>
                  ...
                  <p className={`transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0.6s', willChange: 'transform, opacity' }}>
                  ...
                  <p className={`transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0.7s', willChange: 'transform, opacity' }}>
                  ...
                  <ul className={`list-disc list-inside space-y-2 ml-4 transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0.8s', willChange: 'transform, opacity' }}>
                  ...
                  <p className={`transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0.9s', willChange: 'transform, opacity' }}>
                  ...
                  <p className={`transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '1.0s', willChange: 'transform, opacity' }}>
                  ...
                  <p className={`transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '1.1s', willChange: 'transform, opacity' }}>
                    Trân trọng cảm ơn và kính chúc Quý vị luôn mạnh khỏe, hạnh phúc!
                  </p>
                  <div className={`text-center mt-8 transition-all duration-800 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '1.2s', willChange: 'transform, opacity' }}>
                    <p className="font-bold text-lg text-gray-800">
                      TRUNG TÂM PHỨC HỢP NGHỈ DƯỠNG IKIGAI VIỆT NAM
                    </p>
